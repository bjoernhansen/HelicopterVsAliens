...
public class SceneryObjectPainter extends Painter<SceneryObject>
{
    ...
    public void paintPalmStem(SceneryObject sceneryObject, int i)
    {
        GraphicsAdapter graphicsAdapter = getGraphicsAdapter();
    ...
    public void paintDesert(SceneryObject sceneryObject, int i)
    {
        GraphicsAdapter graphicsAdapter = getGraphicsAdapter();
    ...
    private static BufferedImage [] paintCactusImage()
    {
        ...
        for(int i = 0; i < 2; i++)
        {
            ...
            GraphicsAdapter graphicsAdapter =  Graphics2DAdapter.withAntialiasingOf(cactusImage[i]);
    ...
    private static BufferedImage [] paintPalmCrownImage()
    {
        ...
        for(int i = 0; i < 2; i++)
        {
            ...
            graphicsAdapter = Graphics2DAdapter.withAntialiasingOf(palmCrownImage[i]);
