...
public final class GraphicsManager
{
    ...
    {
        return new GraphicsAdapterInserter(classOfPaintableEntity);
    }
    ...
    {
        Painter<E> painter = getPainterFor(paintableEntity.getClass()).with(graphicsAdapter);
    ...
    public static final class GraphicsAdapterInserter
    {
        private static final Map<Class<? extends Paintable>, Painter<? extends Paintable>>
            PAINTERS = getPainterMap();
        
        private final Class<? extends Paintable>
            classOfPaintableEntity;
        ...
        private static Map<EnemyModelType, Painter<?>> getEnemyPainterMap()
        {
