...
public class Battery
{
    ...
    {
        int initialUpgradeLevel = helicopterType.getInitialUpgradeLevelFor(ENERGY_ABILITY);
        this.maximumUpgradeLevel = helicopterType.getMaximumUpgradeLevelFor(ENERGY_ABILITY);
