...
public class EnglishFontSpecificationProviderForSwing extends AbstractFontSpecificationProviderForSwing
{
    private final Table<WindowType, StartScreenMenuButtonType, FontSpecification> fontSizes
        = ImmutableTable.<WindowType, StartScreenMenuButtonType, FontSpecification>builder()
                        .put(INFORMATION, BUTTON_1, getFontSpecificationForSize(17))
                        ...
                        .put(DESCRIPTION, BUTTON_1, getFontSpecificationForSize(17))
                        .put(DESCRIPTION, BUTTON_2, getFontSpecificationForSize(12))
                        .put(DESCRIPTION, BUTTON_3, getFontSpecificationForSize(15))
                        ...
                        .put(DESCRIPTION, BUTTON_8, getFontSpecificationForSize(15))
                        .put(HELICOPTER_TYPES, BUTTON_1, getFontSpecificationForSize(17))
                        .put(HELICOPTER_TYPES, BUTTON_3, getFontSpecificationForSize(12))
                        .put(HELICOPTER_TYPES, BUTTON_4, getFontSpecificationForSize(17))
                        .put(HELICOPTER_TYPES, BUTTON_5, getFontSpecificationForSize(16))
                        .put(HELICOPTER_TYPES, BUTTON_6, getFontSpecificationForSize(16))
                        .put(HELICOPTER_TYPES, BUTTON_7, getFontSpecificationForSize(12))
