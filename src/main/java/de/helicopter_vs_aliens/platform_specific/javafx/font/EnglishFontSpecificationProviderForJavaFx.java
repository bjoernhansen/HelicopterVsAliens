...
public class EnglishFontSpecificationProviderForJavaFx extends AbstractFontSpecificationProviderForJavaFx
{
    private final Table<WindowType, StartScreenMenuButtonType, FontSpecification> fontSizes
        = ImmutableTable.<WindowType, StartScreenMenuButtonType, FontSpecification>builder()
                        ...
                        .put(DESCRIPTION, BUTTON_5, getFontSpecificationForSize(16))
                        .put(DESCRIPTION, BUTTON_6, getFontSpecificationForSize(18))
                        .put(DESCRIPTION, BUTTON_8, getFontSpecificationForSize(20))
                        .put(HELICOPTER_TYPES, BUTTON_1, getFontSpecificationForSize(22))
                        .put(HELICOPTER_TYPES, BUTTON_3, getFontSpecificationForSize(18))
                        .put(HELICOPTER_TYPES, BUTTON_4, getFontSpecificationForSize(22))
                        .put(HELICOPTER_TYPES, BUTTON_5, getFontSpecificationForSize(22))
                        .put(HELICOPTER_TYPES, BUTTON_6, getFontSpecificationForSize(22))
                        .put(HELICOPTER_TYPES, BUTTON_7, getFontSpecificationForSize(18))
