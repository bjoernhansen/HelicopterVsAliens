...
public class EnglishFontSpecificationProviderForJavaFx implements FontSpecificationProvider
{
    private final Table<WindowType, StartScreenMenuButtonType, FontSpecification> fontSizes
        = ImmutableTable.<WindowType, StartScreenMenuButtonType, FontSpecification>builder()
                        .put(INFORMATION, BUTTON_4, FontSpecification.getInstanceForSize(15))
                        .put(INFORMATION, BUTTON_5, FontSpecification.getInstanceForSize(18))
                        .put(DESCRIPTION, BUTTON_2, FontSpecification.getInstanceForSize(18))
                        .put(DESCRIPTION, BUTTON_3, FontSpecification.getInstanceForSize(20))
                        .put(DESCRIPTION, BUTTON_5, FontSpecification.getInstanceForSize(16))
                        .put(DESCRIPTION, BUTTON_6, FontSpecification.getInstanceForSize(18))
                        .put(DESCRIPTION, BUTTON_8, FontSpecification.getInstanceForSize(20))
                        .put(HELICOPTER_TYPES, BUTTON_3, FontSpecification.getInstanceForSize(18))
                        .put(HELICOPTER_TYPES, BUTTON_7, FontSpecification.getInstanceForSize(18))
