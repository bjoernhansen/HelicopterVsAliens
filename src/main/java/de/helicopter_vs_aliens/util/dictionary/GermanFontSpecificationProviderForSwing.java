...
public class GermanFontSpecificationProviderForSwing implements FontSpecificationProvider
{
    private final Table<WindowType, StartScreenMenuButtonType, FontSpecification> fontSizes
        = ImmutableTable.<WindowType, StartScreenMenuButtonType, FontSpecification>builder()
                        .put(INFORMATION, BUTTON_1, FontSpecification.getInstanceForSize(15))
                        ...
                        .put(INFORMATION, BUTTON_5, FontSpecification.getInstanceForSize(11))
                        .put(INFORMATION, BUTTON_6, FontSpecification.getInstanceForSize(16))
                        .put(DESCRIPTION, BUTTON_1, FontSpecification.getInstanceForSize(15))
                        .put(DESCRIPTION, BUTTON_2, FontSpecification.getInstanceForSize(11))
                        ...
                        .put(HELICOPTER_TYPES, BUTTON_1, FontSpecification.getInstanceForSize(14))
                        .put(HELICOPTER_TYPES, BUTTON_3, FontSpecification.getInstanceForSize(11))
                        .put(HELICOPTER_TYPES, BUTTON_4, FontSpecification.getInstanceForSize(14))
                        .put(HELICOPTER_TYPES, BUTTON_5, FontSpecification.getInstanceForSize(14))
                        .put(HELICOPTER_TYPES, BUTTON_6, FontSpecification.getInstanceForSize(15))
                        .put(HELICOPTER_TYPES, BUTTON_7, FontSpecification.getInstanceForSize(11))
