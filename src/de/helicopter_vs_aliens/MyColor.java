...
public class MyColor implements Constants
{
	...
	static int 
		random_sunlight_blue = 190;	// Blauanteil der Lichtfarbe
	...
	static GradientPaint 
    	...
    	gradientVariableGray;	// Button-Hintergrundfarbe für hervorgehobene (higlighted = true) Buttons
    ...
    static void calculate_variable_game_colors(int counter)
    {    	
    	if(counter%20 > 9)
    	{
    	...
    	{
    		random_sunlight_blue += lighter ? 1 : -1;
			if(random_sunlight_blue > 205){lighter = false;}
			else if(random_sunlight_blue < 175){lighter = true;}
			else if(MyMath.toss_up(0.045f)){lighter = !lighter;}
			randomLight = new Color(255, 255, random_sunlight_blue);		
    	}
    }
    
    static void calculate_variable_menu_colors(int counter)
	{
    ...
    static Color brighten_up(Color color)
    {
